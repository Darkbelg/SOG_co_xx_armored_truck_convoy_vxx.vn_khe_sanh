...
if (side group player != CIVILIAN) then {
	...
	<br/>Our convoy is transporting fuel to Khe Sanh SF Camp.
	<br/>
	<br/><font size='18' color='#80FF00'>SPECIAL TASKS</font>
	<br/>Drive the convoy to the SF camp. Make sure at least 2 of the 5 fuel trucks arrive.
	...
	<br/>
	<br/>At some point there is some music. So you should raise the volume a bit if it's at 0.
	<br/>
